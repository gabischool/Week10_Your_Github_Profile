...
function MyProfile(props) {
  ...
  return (
    ...
    <h4 className="text-md font-medium leading-3">Achievements</h4>
    <a href={profile.Achievements} className="text-sm text-blue-600">
     {profile.blog}
    </a>

    <h4 className="text-md font-medium leading-3">Galaxy Brain</h4>
    <a href={profile.Achievements} className="text-sm text-blue-600">
     {profile.blog}
    </a>
    <h4 className="text-md font-medium leading-3">Highlights</h4>
    <a href={profile.Highlights} className="text-sm text-blue-600">
     {profile.blog}
    </a>
    ...
    <Routes>
      <Route path="/" element={<FollowingList following={following}/>}/>
