...
import FollowingList from './following/FollowingList.js';
...
function MyProfile(props) {
  ...
  return (
   ...
   <Routes> 
   <Route  path='/' element={<FollowingList />} FollowingList={followers}/>
   <Route  path='/following' element={<FollowersList/>}FollowersList={following}/>
   </Routes>
    </div>
  </div>
  )
