...
function App() {
  ...
  useEffect(() => {
    axios.get('https://api.github.com/users/Hanaafilsan')
      .then(res => { setprofile(res.data) }).catch(err => { console.log(err) });
    axios.get('https://api.github.com/users/Hanaafilsan/followers').then(res => { setfollowers(res.data) })
      .catch(err => { console.log(err) });
    axios.get('https://api.github.com/users/Hanaafilsan/following').then(res => { setfollowing(res.data) })
      .catch(err => { console.log(err) });
    axios.get('https://api.github.com/users/Hanaafilsan/repositories').then(res => { setoverview(res.data) })
      .catch(err => { console.log(err) });
  }, [])
  console.log('hanuuza', profile)
  console.log('hanuuza followers', followers)
